...
message2 = tk.Label(window, text="" ,fg="red"   ,bg="black",activeforeground = "green",width=30  ,height=2  ,font=('times', 15, ' bold ')) 
...
#copyWrite.insert("insert", "Developed by Pratik","", "TEAM", "superscript")
